...
<head>
    ...
    <title>Node Sensor 3 - Greenhouse Monitoring</title>
        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm text-center">
                    <p class="text-6xl text-blue-500 font-semibold">78<span class="text-2xl">°C</span></p>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm text-center">
                    <p class="text-6xl text-green-500 font-semibold">79<span class="text-2xl">%</span></p>
                    <div class="flex items-center justify-center mt-2">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm text-center">
                    <p class="text-6xl text-yellow-500 font-semibold">3100<span class="text-2xl">Lux</span></p>
                    <div class="flex items-center justify-center mt-2">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm text-center">
                    <p class="text-6xl text-purple-500 font-semibold">5<span class="text-2xl">%</span></p>
                    <div class="flex items-center justify-center mt-2">
